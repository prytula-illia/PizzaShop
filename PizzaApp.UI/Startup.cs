...
namespace PizzaApp.UI
{
    public class Startup
    {
        ...
        {
            services.Configure<PizzaShopDbSettings>(
                Configuration.GetSection(nameof(PizzaShopDbSettings)));

            services.AddSingleton<IPizzaShopDbSettings>(sp =>
                sp.GetRequiredService<IOptions<PizzaShopDbSettings>>().Value);

            services.AddScoped<IRepository<Ingridient>, IngridientRepository>();
            ...
            services.AddScoped<ICrud<PizzaModel>, PizzaService>();
